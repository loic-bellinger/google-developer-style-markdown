...
- Numbers from zero through nine, except as noted in
  [Numbers as numerals](https://developers.google.com/style/numbers#numbers-as-numerals).
...
[sub-steps in numbered procedures](https://developers.google.com/style/procedures#sub-steps-in-numbered-procedures).
