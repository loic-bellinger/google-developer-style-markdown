...
[Visual formatting](https://developers.google.com/style/semantic-tagging#visual-formatting).
...
:   When you're discussing or introducing terms, such as when defining terms or using
    *words as words*, use italics formatting, `<i>` or `_`. For more
    ...
    and
    [Format abbreviation introductions](https://developers.google.com/style/abbreviations#format-abbreviations).
:   When you need to add emphasis to indicate importance, use italics, not bold or underline. But
    ...
    [semantic emphasis](https://developers.google.com/style/semantic-tagging) in HTML, use the `em` element,
...
:   Use code font to mark up code, such as filenames, class names, method names, HTTP status codes,
    ...
    in code font](https://developers.google.com/style/code-in-text#some-specific-items-to-put-in-code-font).
...
:   Use sentence case in all [headings,
    titles, and navigation](https://developers.google.com/style/capitalization#capitalization-in-titles-and-headings).
...
:   In general, use American English style when [punctuating
    quotations](https://developers.google.com/style/quotation-marks).
