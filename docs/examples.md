...
[placeholders](https://developers.google.com/style/placeholders), like
...
in
[Example domain names](https://developers.google.com/style/examples#example-domain-names)
and one of the names listed in [Example person names](https://developers.google.com/style/examples#example-person-names)---for
...
Use the [gender-neutral singular pronouns](https://developers.google.com/style/pronouns#gender-neutral-pronouns)
...
[Format phone numbers in HTML or Markdown](https://developers.google.com/style/phone-numbers#format-phone-numbers).
