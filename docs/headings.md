...
[contractions](https://developers.google.com/style/contractions) and [articles](https://developers.google.com/style/articles).

### Syntax and capitalization

- **Use sentence case** for all headings and titles. For more information, see [Capitalization in titles and
  headings](https://developers.google.com/style/capitalization#capitalization-in-titles-and-headings).
...
- **Avoid code items in headings** . If you must mention a code item in a heading, add a descriptive noun to the item in code font. For more information, see [Grammatical treatment of code elements](https://developers.google.com/style/code-in-text#grammatical-treatment-of-code-elements).
