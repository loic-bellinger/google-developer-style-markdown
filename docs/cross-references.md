...
cross-reference, see
[Capitalization in references to titles and headings](https://developers.google.com/style/capitalization#capitalization-in-references-to-titles-and-headings).
...
[Clarify the purpose of a link](https://developers.google.com/style/cross-references#clarify-purpose)
...
information, see the
[Write link introductions](https://developers.google.com/style/cross-references#link-introductions) section
of this document.
...
- **Links to sections on the same page.** When you're
  ...
  Recommended: For more
  information, see the
  [Write descriptive link text](https://developers.google.com/style/cross-references#descriptive-link-text)
  section of this document.
