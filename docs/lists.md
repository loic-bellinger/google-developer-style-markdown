...
[List or table?](https://developers.google.com/style/tables#list-or-table)
...
[following](https://developers.google.com/style/word-list#following) in the word list).
...
[Capitalization and end punctuation](https://developers.google.com/style/lists#capitalization).
...
[Procedures](https://developers.google.com/style/procedures#sublists).
...
[parallel construction](https://developers.google.com/style/lists#parallel) or add end punctuation to every list item
for consistency.
Recommended:
...
lists](https://developers.google.com/style/dashes#colons-instead-of-dashes-in-description-lists).
Recommended:
...
> [!NOTE]
> **Note** : The guidelines here about list punctuation differ from the [Material
> Design guidelines](https://material.io/guidelines/style/writing.html#writing-capitalization-punctuation). If you're writing UI text rather than prose documentation, then follow the Material Design guidelines.

## Comma-separated lists

When you write a list in a paragraph, use
[serial commas](https://developers.google.com/style/commas#serial-commas) to separate the items.
