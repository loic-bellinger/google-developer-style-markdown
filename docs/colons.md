...
run-in headings](https://developers.google.com/style/lists#description-lists-that-use-run-in-headings).
...
[Capitalization and colons](https://developers.google.com/style/capitalization#capitalization-and-colons).
