...
> [!NOTE]
> **Note** : For information about how to use quotation marks with links, see [Quotation marks and italics](https://developers.google.com/style/cross-references#quotation-marks-italics).
