...
> element](https://html.spec.whatwg.org/multipage/semantics.html#the-b-element) is that in modern HTML, `b` connotes text to which you want to draw visual attention, whereas the [`strong`
...
[Prepositions](https://developers.google.com/style/ui-elements#prepositions) table.
...
A *section* is a labeled grouping of options and controls, usually within a window, pane, or panel. Do not use terms such as *area* or *column* to refer to a section. Recommended: In the **Create metric** pane, do the
following:
...
To refer to a menu, use the form *the **<var translate="no">LABEL_NAME</var>** menu.*
...
This notation is useful for abbreviating a longer phrase like *In the **File** menu, select **Open**.* However, this notation applies only to
...
[empty `alt` attribute](https://developers.google.com/style/images#alt-text).
...
- Use the button icon along with its name as shown in the button tooltip. Recommended: Click
  **Refresh**.
- Add context to help the user find the element. Recommended: On the Cloud Run toolbar, click
  **Refresh**.
- Use a screenshot.
...
to a tab, use the form *the **<var translate="no">LABEL_NAME</var>** tab*.
...
*box* and the form *the **<var translate="no">LABEL_NAME</var>** box*. Format the text
...
the form *the **<var translate="no">LABEL_NAME</var>** list* or
*the **<var translate="no">LABEL_NAME</var>** box*, whichever is clearer.

Recommended: In the **Item** list, select
**Desktop**.

A *combo box* is a combination of a text box and a list box. To
refer to a combo box, use the form *the **<var translate="no">LABEL_NAME</var>** box*. To refer to
...
arrows or by typing. To refer to a spin box, use the form *the **<var translate="no">LABEL_NAME</var>** box*. To refer to entering a value into a spin
...
on or off. To refer to a checkbox, use the form *the **<var translate="no">LABEL_NAME</var>** checkbox*.
...
form *the <kbd><var translate="no">KEY_NAME</var></kbd> key*.

Recommended: Press <kbd>Esc</kbd>.

Recommended: Press the <kbd>Esc</kbd> key.
...
form *<kbd><var translate="no">MODIFIER</var>+<var translate="no">KEY_NAME</var></kbd>*.
...
<kbd>Ctrl+C</kbd> (<kbd>⌘+C</kbd>).

To refer to a key or combination that uses the Shift key, use the form
*<kbd><var translate="no">MODIFIER</var>+Shift+<var translate="no">KEY_NAME</var></kbd>*.

Recommended: Press
<kbd>Control+Shift+?</kbd>.
