...
Avoid using *'s* to form a plural noun. For more information, see [Pluralization](https://developers.google.com/style/pluralization).
...
elements](https://developers.google.com/style/code-in-text#grammatical-treatment-of-code-elements).
