...
[writing for a global audience](https://developers.google.com/style/translation) and reduces
confusion.
...
format](https://developers.google.com/style/dates-times#numeric-only-date-format)). Different regions of the world put parts of the date in a different
