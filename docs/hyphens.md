...
guidance in the [word list](https://developers.google.com/style/word-list)
...
[suspended hyphen](https://developers.google.com/style/hyphens#suspended-hyphens), in which case you can leave a space after
